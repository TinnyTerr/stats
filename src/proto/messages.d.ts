 ...
 */
import type { Container, HostFacts, ListeningPort, LogLine, LogQuery, NodeCapabilities, NodeIdentity, NodeSummary, ProcessInfo, ProjectSpec, ProjectStatus, SystemdSummary, SystemdUnit, SystemdUnitDetail, SystemStats, Telemetry } from "../types.ts";
...
export declare const NodeAction: {
    ...
    readonly FactsRefresh: "facts.refresh";
    ...
    readonly UnitShow: "unit.show";
    readonly UnitAction: "unit.action";
    readonly ContainerAction: "container.action";
    readonly ProjectsList: "projects.list";
    readonly ProjectsReload: "projects.reload";
    readonly ProjectAction: "project.action";
};
/** Actions the browser sends to the hub. Anything else is relayed to a node. */
export declare const HubAction: {
    readonly Nodes: "nodes";
    readonly Node: "node";
    readonly History: "history";
    readonly Events: "events";
    readonly Info: "info";
    readonly Forget: "node.forget";
};
